...
def  MVO(objf,lb,ub,dim,N,Max_time,trainInput,trainOutput,testInput, testOutput):
    "parameters"
    #dim=30
    #lb=-100
    #ub=100
   ...
   #(i.e the randomly generated individual has at least one value 1)       
            ...
            Inflation_rates[i]=objf(Universes[i,:],trainInput,trainOutput,dim,testInput, testOutput);
