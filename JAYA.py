...
def JAYA(objf,lb,ub,dim,SearchAgents_no,Max_iter,trainInput,trainOutput,testInput, testOutput):
    ...
    for l in range(0,Max_iter):
        ...
        for i in range(0,SearchAgents_no):
            ...
            for j in range (0,dim):     
                ...
                ss= transfer_functions_benchmark.s1(New_Position[j])
            ...
            new_fitness = objf(New_Position,trainInput,trainOutput,dim,testInput, testOutput)
