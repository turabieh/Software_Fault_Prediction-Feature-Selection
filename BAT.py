...
def BAT(objf,lb,ub,dim,N,Max_iteration,trainInput,trainOutput,testInput, testOutput):
   ...
   # Sol=numpy.random.rand(n,d)*(ub-lb)+lb      #generating continuous individuals
    ...
    for i in range(0,n):    
        Fitness[i]=objf(S[i,:],trainInput,trainOutput,dim,testInput, testOutput)
    ...
    for t in range (0,N_gen): 
        ...
        #  Sol=numpy.clip(Sol,lb,ub)
            ...
            Fnew=objf(S[i,:],trainInput,trainOutput,dim,testInput, testOutput)
