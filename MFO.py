...
def MFO(objf,lb,ub,dim,N,Max_iteration,trainInput,trainOutput,testInput, testOutput):
   ...
   #(i.e the randomly generated individual has at least one value 1)       
            ...
            # evaluate moths
            Moth_fitness[i]=objf(Moth_pos[i,:],trainInput,trainOutput,dim,testInput, testOutput)
